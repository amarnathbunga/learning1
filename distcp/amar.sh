...
#REQDIR="/user/dh-ads/nrt_ads_events/properties_et_year=$year/properties_et_month=$month/properties_et_day=$day"
year=2020
month=9
day=19
REQDIR="/user/dh-ads/nrt_ads_events/properties_et_year=$year/properties_et_month=$month/properties_et_day=$day"
...
echo $month
echo $day
hadoop distcp -D dfs.replication=2 -Dmapred.job.queue.name=default --update hdfs://$namenode:8020$REQDIR hdfs://cdhadsnrt:8020$REQDIR

...
IMPDIR="/orc-hive-staging/josh_nrt_ads_events/event_year=$year/event_month=$month/event_day=$day"
#LDIR="/orc-hive-staging/ads_server_ad_request/properties_et_year=$year/properties_et_month=$month"
echo $DIR
echo $year
echo $month
echo $day
hadoop distcp -D dfs.replication=2 -Dmapred.job.queue.name=nrt --update hdfs://cdhadsnrt:8020$IMPDIR hdfs://$namenode:8020$IMPDIR

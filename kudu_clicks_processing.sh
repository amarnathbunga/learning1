...
then
  ...
  subject="Josh NRT data pipe: Kudu Josh Click Processor failed"
        html_body="<html><body>Spark job for Kafka to kudu processor for Josh Clicks has failed.</body></html>"
